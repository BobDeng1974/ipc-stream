// Last Update:2018-12-16 17:50:28
/**
 * @file adts.c
 * @brief 
 * @author liyq
...
int AacDecodeAdts( IN char *_pFrame, int _nLen, OUT Adts *_pAdts, int *_pSize )
{
